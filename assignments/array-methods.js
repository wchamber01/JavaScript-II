...
let fullNames = [];
runners.forEach(firstNameLastName);
function myFunction(runners[].first_name + runners[].last_name) {
  fullNames.push = myFunction
}
// function getNames(firstName, lastName){
//   for (let i of runners[]) {
//     console.log(i);
//     fullNames.push 

//   }
  
//   fullNames.push = `${arrItems.first_name} ${arrItems.last_name}`
//   return fullNames;
// };
